...
$(function () {
  ...
  var e,
    s = $(".datatables-users"),
    i = $(".select2"),
    r = "./template-calendar-event-customize.html"
  i.length &&
    (i = i)
      .wrap('<div class="position-relative"></div>')
    s.length &&
      (e = s.DataTable({
        ajax: assetsPath + "json/template-calendar-event-list-.json",
        columns: [
          { data: "" },
          { data: "template_code" },
          { data: "template_code" },
        ...
        buttons: [
          {
            ...
            action: function() {
              window.location.href = './template-calendar-event-create.html';
            }
          },
        ],
        responsive: {
