...
$(function () {
  ...
  if (s.length) {
      ...
      columnDefs: [
        {
          ...
          render: function (data, type, row, meta) {
            var getStatusIcon = function (status) {
              switch (status) {
                ...
                case "Waiting Asset Disposal":
                  return '<i class="mdi mdi-clock-time-four mdi-20px text-warning me-1"></i>';
                case "Reject":
                  return '<i class="mdi mdi-close-circle mdi-20px text-secondary me-1"></i>';
                case "Waiting Completed":
                  return '<i class="mdi mdi-timer-sand-full mdi-20px text-info me-1"></i>';
                default:
                  return "";
              }              
            };
            ...
            return (
              "<div>" +
              "<a href='./admin-approval-asset-disposal-detail.html'>" +
    ...
    $(".datatables-asset-disposal tbody").on(
      "click",
      ".delete-record",
      function () {
