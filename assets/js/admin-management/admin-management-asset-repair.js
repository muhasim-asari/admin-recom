...
$(function () {
  ...
  if (s.length) {
    e = s.DataTable({
      ajax: assetsPath + "json/admin-approval/list-asset-repair.json",
      columns: [
        { data: "asset_repair_created_date" },
        { data: "transaction_number" },
        { data: "person_in_charge" },
        { data: "asset_repair_date" },
        { data: "action" },
      ],
      bLengthChange: false,
      bInfo: true,
      columnDefs: [
        {
          ...
          render: function (data, type, row, meta) {
            ...
            return (
              "<div>" +
                "<a href='./admin-management-repair-detail.html'>" +
      ...
      buttons: [
        ...
        },
        {
          ...
          action: function () {
            window.location.href = "./admin-management-repair-add.html";
          },
        },
      ],
