  ...
  $(".datatables-asset-out-detail").DataTable({
    ...
    initComplete: function () {
      ...
      var filteredData = data.filter(function (item) {
        return item.status === "Waiting Asset Out";
      });
    ...
    columnDefs: [
      {
        ...
        render: function (e, t, a, n) {
          return '<button class="btn btn-outline-primary btn-sm waves-effect" data-bs-toggle="modal" data-bs-target="#assetOut">Asset Out</button>'
        },
      },
    ],
    initComplete: function () {
