...
$(function () {
  let t, a, n;
  var e;
  var s = $(".datatables-asset-disposal");
  var i = $(".select2");
  ...
  if (s.length) {
    e = s.DataTable({
      ajax: assetsPath + "json/admin-approval/list-asset-disposal.json",
      columns: [
        { data: "asset_disposal_created_date" },
        { data: "transaction_number" },
        { data: "person_in_charge" },
        { data: "asset_disposal_date" },
        { data: "action" },
      ],
      bLengthChange: false,
      bInfo: true,
      columnDefs: [
        {
          ...
          render: function (data, type, row, meta) {
            ...
            return (
              "<div>" +
                "<a href='./admin-management-asset-in-detail.html'>" +
      ...
      buttons: [
        ...
        {
          text: '<i class="mdi mdi-plus me-0 me-sm-1"></i><span class="d-none d-sm-inline-block">Add Asset Disposal</span>',
          className: "add-new btn btn-primary mx-3",
          action: function () {
            window.location.href = "./admin-management-asset-disposal-add.html";
          },
        },
      ],
