    ...
    (e = s.DataTable({
      ...
      columnDefs: [
        ...
        },
        {
          ...
          orderable: !1,
          render: function (e, t, a, n) {
            return '<a href="./admin-management-asset-assigment-employee-asset-list.html" class="text-primary me-2"><i class="mdi mdi-eye-outline me-2"></i><span>Show Asset</span></a>';
          },
        },
      ],
      order: [[2, "desc"]],
