...
!(function () {
  ...
  (s = document.querySelector("#weeklyOverviewChart")),
    (i = {
      ...
      series: [
        { name: "Sales", type: "column", data: [83, 68, 56, 65, 65, 50, 39] },
        { name: "Sales", type: "line", data: [63, 38, 31, 45, 46, 27, 18] },
      ],
      plotOptions: {
        bar: {
          borderRadius: 9,
      ...
      yaxis: {
        ...
        labels: {
          ...
          style: { fontSize: "0.75rem", fontFamily: "Inter", colors: t },
        },
      },
      states: {
        hover: { filter: { type: "none" } },
    ...
    (l = {
      ...
      series: [
        { name: "Google Analytics", data: [155, 135, 320, 100, 150, 335, 160] },
        { name: "Facebook Ads", data: [110, 235, 125, 230, 215, 115, 200] },
      ],
      plotOptions: {
        bar: {
          horizontal: !1,
